...
class HomeController extends Controller
{
    ...
    public function index(Request $request,$id=null)
    {
        ...
        $friends = User::where('id','!=',Auth::id())->select('*',DB::raw("(SELECT count(id)from chats where chats.other_user_id=$user_id
         and chats.user_id=users.id and is_read=0)as unread_messages"))->get()->toArray();
